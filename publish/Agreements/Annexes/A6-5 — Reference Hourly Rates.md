...
tags:
  ...
  - rates
---
*Annex 5 to the [Partnership Agreement](../Agreement%206%20%E2%80%94%20Partnership.md). Defines the reference hourly rates used when contributions are measured in hours. Forms an integral part of the Agreement. Rates are reviewed annually.*

---

## Purpose

When a Project Sheet (see [A6-4 — Project Sheet Template](A6-4%20%E2%80%94%20Project%20Sheet%20Template.md)) specifies that contributions will be measured by hours, this Annex provides the agreed reference rates. These rates convert hours into a monetary value for the purpose of calculating each Partner's proportional share in Net Project Revenue distribution.
...
## Section A — Reference Rates by Activity Type
...
## Section B — Contribution of Pre-Existing IP or Assets
...
## Section C — Client-Rate Adjustments
...
Reference rates are reviewed annually by the Partners based on market conditions, cost of living adjustments, and the network's financial sustainability. Any change requires a simple majority vote and a signed amendment to this Annex.

**Last reviewed:** [DD/MM/YYYY]  **Next review due:** [DD/MM/YYYY]

**Applicable from:** [DD/MM/YYYY] *(rates apply to contributions logged on or after this date)*
