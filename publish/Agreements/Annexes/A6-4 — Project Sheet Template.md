...
tags:
  ...
  - project
---
*Annex 4 to the [Partnership Agreement](../Agreement%206%20%E2%80%94%20Partnership.md). Template for activating a new Project under the Framework. Complete one sheet per Project. File as: "A6-4 — [Project Name] — [YYYY-MM]". Forms an integral part of the Agreement.*
...
[2–5 sentences describing the Project, its deliverables, and its purpose. Be specific enough that a new Partner reading this document would understand the scope.]
...
☐ **Hours** — at rates defined in [A6-5 — Reference Hourly Rates](A6-5%20%E2%80%94%20Reference%20Hourly%20Rates.md)
☐ **Fixed milestones** — as defined in Section 3 above
☐ **Agreed value units** — describe: ___
☐ **Market replacement value** — describe: ___
☐ **Hybrid** — describe: ___

**Tracking tool / ledger:** [e.g. "Contribution Ledger platform — see [A6-6 — Validation Platform Description](A6-6%20%E2%80%94%20Validation%20Platform%20Description.md)" or "Shared spreadsheet until platform is operational"]
...
**Structure costs** (per [A6-3 — Structure Costs and Allocation](A6-3%20%E2%80%94%20Structure%20Costs%20and%20Allocation.md)):** €___ (estimated)
