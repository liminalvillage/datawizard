...
tags:
  ...
  - cleaning
---
*Annex 4 to the [Asset Use Agreement (Comodato d'Uso)](../Agreement%201%20%E2%80%94%20Asset%20Use.md). Sets out the cleaning and restoration standards required at the end of each use period. Forms an integral part of that Agreement. To be used by stewards and departing participants.*
...
## Section B — End-of-Stay Checklist

*To be completed and signed off by the steward before departure. Retain a copy in the maintenance log.*
...
## Section C — Damage Reporting

Any damage, breakage, or defect discovered during the clean-up or handover must be reported immediately to the Association coordinator, with:
...
## Section D — Ecological Restoration Standards
