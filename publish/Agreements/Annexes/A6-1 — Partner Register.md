...
tags:
  ...
  - partnership
---
*Annex 1 to the [Partnership Agreement](../Agreement%206%20%E2%80%94%20Partnership.md). The canonical register of all Partners. Updated upon admission of each new Partner. Forms an integral part of the Agreement.*
...
*Optional but useful for project routing — identify each Partner's primary contribution domain.*
...
|---|---|---|---|
| [e.g. Partner 3 admitted] | [DD/MM/YYYY] | [Two-thirds majority] | [Accession instrument attached] |

---

*This register is a living document. It does not require re-execution of the full Partnership Agreement when updated — a signed amendment or accession instrument is sufficient.*
