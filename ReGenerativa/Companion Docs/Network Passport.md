...
## What the Network Passport is

Every person who contributes to this network accumulates a single, portable record of
their contributions. It travels with them across roles, across hubs, across time. It
does not reset. It does not expire. It grows.

The Network Passport is that record. It lives in the Contribution Ledger (a plain,
shared, visible log — not a blockchain) and belongs entirely to the person who holds
it. It is theirs to carry into new roles and present as evidence of who they have shown
themselves to be in this network.
