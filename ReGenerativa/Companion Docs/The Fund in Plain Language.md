...
1. **A small slice goes to the network.** Off the top of any earnings, a modest contribution funds the shared things no single place pays for (the Network Regeneration Contribution).
2. **The place covers its own costs.** Upkeep, insurance, and the real cost of the people who keep it running are met first, before anything is spent freely.
3. **Those who tend it direct what is left.** The people actively caring for the place decide how to use its spare money, within its purpose and a ceiling — funding what the place needs next.
...
1. **Need first** — real operating needs are met before any free spending.
2. **Subsidiarity** — within its purpose and ceiling, the place decides; no one upstream pre-approves its in-scope spending.
3. **Two-part purpose** — every allocation serves both the place's own mission and the wider regeneration.
4. **No personal income** — no one allocates money to their own benefit; no flow is a profit payout.
5. **Mutual aid** — a place in genuine shortfall is supported; a place in lasting surplus contributes.
