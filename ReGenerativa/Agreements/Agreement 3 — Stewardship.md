...
*Every asset needs a keeper — and every place, a face; sometimes one, sometimes many. The Stewards are the network's living presence at the thing entrusted — not its owners, not its tenants, but its custodians: those who keep it sound and put it to good use, and, where it is a place, open the door, tend the rhythms, and hold the conditions in which a regenerative space stays alive between gatherings. An asset may be held by one keeper or by many; where many, they hold it together, each according to what they tend. They are the bridge between ownership and community, between the asset and the people it serves. A Steward has chosen to put themselves between a thing and its possibilities — whether that thing is a parcel of land, a workshop, a vehicle, a tool, or a whole place. This Agreement is the network's answer to that choice. It offers the standing of being entrusted, the freedom of working within a framework rather than against one, and the recognition that comes from being the one others can call.*
...
**[Steward's Full Name]**, born on [date] in [city], residing at [address], tax code/ID no. [ID number], an individual who wishes to serve as steward in collaboration with the Association (hereinafter, the "Steward").

*The Association and the Steward are hereinafter jointly referred to as the "Parties" and individually as a "Party."*
...
**11.3** The Steward shall make reasonable efforts to clarify expectations, support co-responsibility, reduce avoidable tensions, address problems early, and escalate serious issues to the Association.
...
**13.1** The Steward shall keep confidential any sensitive information obtained through the stewardship role, including personal information about members or participants, internal plans, and non-public financial or operational information.

**13.2** This confidentiality obligation continues after termination of this Agreement.
...
**15.2** The Parties may define a trial period, a seasonal stewardship period, a rotating steward structure, or a project-based stewardship period.
...
**17.2** The Association shall indemnify and hold the Steward harmless from third-party claims arising from carrying out Association activities, provided the Steward was acting within their authorised role and not engaging in misconduct. This indemnification is in line with the Association's insurance coverage.
