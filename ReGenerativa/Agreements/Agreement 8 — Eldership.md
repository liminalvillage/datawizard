...
tags:
  ...
  - ReGenerativa
---
*Incorporates the [[General Terms and Conditions]] in full. Standard provisions (Regenerative Covenant, network regeneration contribution, digital infrastructure, data protection, force majeure, dispute resolution, governing law, severability, continuity) are set out therein and apply to this Agreement without repetition.*

---

*Every living system needs its elders. Not as a sentimental gesture toward the past, but as a structural necessity: someone must carry the memory of the whole, hold the thread of original intention, and speak when the network risks forgetting what it is. The Elder has already given. They have stewarded land, taught knowledge, built ventures, held communities through difficulty, and remained. This Agreement is the network's answer to that gift. It does not ask for more. It offers recognition, voice, belonging, and rest — freely, permanently, and without condition.*
...
**[Elder's Full Name]**, born on [date] in [city], residing at [address], tax code/ID no. [ID number], a long-term contributor to the network whose standing is recorded in the Contribution Ledger and recognised herein (hereinafter, the "Elder").

*The Association and the Elder are hereinafter jointly referred to as the "Parties" and individually as a "Party."*

---

## 1. Purpose and Principle

**1.1** This Agreement formalises the transition of the Elder from active operational contribution into the network's governance and wisdom layer. It is not an exit. It is a deepening — from doing to witnessing, from building to holding, from serving the network to being served by it.
...
## 3. The Transition Rite

**3.1** Entry into Eldership is marked by a **Transition Rite** — a formal act of community recognition conducted in the presence of the network, or a gathered portion of it. The Rite is not administrative. It is relational: the community names what the Elder has given, and commits aloud to what it will give in return.

**3.2** The form of the Rite is determined by the receiving community in dialogue with the Elder. It may be seasonal, ceremonial, or simple — but it shall be witnessed, and its occurrence shall be recorded in the Contribution Ledger as a Validated Contribution event of the highest order.

**3.3** The Association shall inscribe the Elder's name, the date of transition, and a brief narrative of their contribution arc permanently in the network's living history — a record that persists independently of any agreement, role, or hub.

---

## 4. What the Network Gives

**4.1 Unconditional Hospitality.** The Elder is entitled to welcome at any hub in the network — accommodation, meals, and full participation in community life — at no cost and without requiring a prior contribution in exchange. This is not a favour. It is the primary obligation this Agreement creates.
...
**(c) Living Probiviri.** The Elder Council serves as the primary internal mediation body for disputes that reach the network's governance core — replacing and fulfilling the Collegio dei Probiviri role referenced in GT-7.2 when constituted. Its mediation opinions are non-binding in law but carry the weight of the network's deepest relational authority.
...
## 6. What the Elder Gives

**6.1 Presence.** The Elder commits to attending, in person or remotely, the Elder Council's annual gathering except in cases of genuine incapacity. This is the only formal obligation this Agreement creates.

**6.2 Non-Extraction Covenant.** The Elder commits not to use their Elder status, Passport standing, or access rights for commercial advantage — including but not limited to: leveraging hub access for personal business activities, using the Elder Council's authority for private gain, or representing themselves externally as an agent or representative of the Association without explicit written authorisation.

**6.3 Informal Availability.** The Elder is not obligated to mentor, advise, teach, or serve the community in any structured way. If they choose to do so, those contributions are recorded in the Contribution Ledger as Validated Contributions. But choice is the operative word. The network receives the Elder's presence as a gift — not a service.

---

## 7. Relationship to Other Agreements

**7.1** This Agreement stacks with all other agreements in the constellation (GT-11.4). An Elder may simultaneously hold the Stewardship Agreement, the Mentorship Agreement, or any other — but Agreement 8 is never subordinate to those relationships. The Elder's standing as Elder takes precedence in all matters of governance and recognition.

**7.2** If the Elder holds another agreement and a conflict arises between the obligations of that agreement and the standing or dignity of the Elder role, the Parties shall resolve the conflict through good faith discussion. The Elder Council may be consulted.

**7.3** The Elder may choose to step back from any active agreement without affecting their Elder status. Eldership is not conditional on continued operational contribution.

---

## 8. Duration and Continuity
