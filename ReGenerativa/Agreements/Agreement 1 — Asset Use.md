---
title: Agreement 1 — Asset Use
type: agreement
agreement_ref: '1'
agreement_name: Asset Use Agreement
layer: Root
italian_law_basis: Comodato d'uso — Art. 1803-1812 Civil Code
...
**6.3 Automatic Termination.** This Agreement shall terminate automatically if the Association is dissolved, ceases to operate as a legal entity, or loses its status under Italian law. The Agreement may also terminate automatically if the Owner transfers ownership of the Asset to another party, unless the successor agrees in writing to assume the Owner's obligations hereunder.
