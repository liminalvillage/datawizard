...
- **Contribution credit (refined)** - rewards the *choice* to restrain (voluntary, early feed-up, not the forced overflow at the edge), measured as *proportional restraint* (capped, so wealth cannot buy standing), earning **network-tier standing** - a voice in how the Council directs across-hub infrastructure, never more power over your own hub. Distributed among co-stewards by their local share, and self-balancing: starving your own place to farm network voice drops your local standing, which is what distributes the credit. (Flagged as interesting; needs further refinement before adoption.)
...
- **Open seam - the Elder Council.** Network-tier standing earned by feeding up sits awkwardly beside the Council's elder-based composition (A8: qualify by holding agreements for a minimum period). Is network voice a separate organ, or absorbed into the Charter? This is the one genuinely unresolved design point. Recommend leaving it open rather than forcing it.
